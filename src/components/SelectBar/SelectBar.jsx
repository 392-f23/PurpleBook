...
const SelectBar = () => {
    ...
    const handleButtonClick = () => {
        ...
        if (selectedCourtName && selectedSport) {
            navigate(`/place/${selectedCourtName}`, { state: data.sport[selectedSport][selectedCourtName] });
        } else {
            ...
            <div className="selectbar-selectbar-accrodin-container">
                <Accordion disableGutters className="selectbar-selectbar-accrodin">
                    ...
                    <AccordionDetails className="selectbar-selectbar-accrodin-content">
                        ...
                        <FormControlLabel control={<Checkbox checked={checkedInfo['basketball']} onChange={handleCheckboxChange('basketball')}/>} label="Basketball" />
                        <FormControlLabel control={<Checkbox checked={checkedInfo['tennis']} onChange={handleCheckboxChange('tennis')}/>} label="Tennis" />
                        <FormControlLabel control={<Checkbox checked={checkedInfo['badminton']} onChange={handleCheckboxChange('badminton')}/>} label="Badminton" />
                        </div>
                    </AccordionDetails>
                </Accordion>
                ...
                {Object.keys(selectedCourts).length === 0 || Object.keys(selectedData).length === 0 ? (
